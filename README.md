...
* **[Download cctv-viewer2-2.0.4-1-x86_64.pkg.tar.zst](https://github.com/Arkanista/cctv-viewer2/releases/download/v2.0.4/cctv-viewer2-2.0.4-1-x86_64.pkg.tar.zst)**

To install the downloaded package:
```bash
sudo pacman -U cctv-viewer2-2.0.4-1-x86_64.pkg.tar.zst
```
