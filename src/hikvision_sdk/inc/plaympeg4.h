...
PLAYM4_API BOOL   PlayM4_InitDDraw(HWND hWnd);
//Release directDraw; Now invalid.
PLAYM4_API BOOL  PlayM4_RealeseDDraw();
PLAYM4_API BOOL  PlayM4_OpenFile(LONG nPort,LPSTR sFileName);
PLAYM4_API BOOL  PlayM4_CloseFile(LONG nPort);
PLAYM4_API BOOL  PlayM4_Play(LONG nPort, HWND hWnd);
PLAYM4_API BOOL  PlayM4_Stop(LONG nPort);
PLAYM4_API BOOL  PlayM4_Pause(LONG nPort,DWORD nPause);
PLAYM4_API BOOL  PlayM4_Fast(LONG nPort);
PLAYM4_API BOOL  PlayM4_Slow(LONG nPort);
PLAYM4_API BOOL  PlayM4_OneByOne(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetPlayPos(LONG nPort,float fRelativePos);
PLAYM4_API float  PlayM4_GetPlayPos(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetFileEndMsg(LONG nPort,HWND hWnd,UINT nMsg);
PLAYM4_API BOOL  PlayM4_SetVolume(LONG nPort,WORD nVolume);
PLAYM4_API BOOL  PlayM4_StopSound();
PLAYM4_API BOOL  PlayM4_PlaySound(LONG nPort);
PLAYM4_API BOOL  PlayM4_OpenStream(LONG nPort,PBYTE pFileHeadBuf,DWORD nSize,DWORD nBufPoolSize);
PLAYM4_API BOOL  PlayM4_InputData(LONG nPort,PBYTE pBuf,DWORD nSize);
PLAYM4_API BOOL  PlayM4_CloseStream(LONG nPort);
PLAYM4_API int    PlayM4_GetCaps();
PLAYM4_API DWORD  PlayM4_GetFileTime(LONG nPort);
PLAYM4_API DWORD  PlayM4_GetPlayedTime(LONG nPort);
PLAYM4_API DWORD  PlayM4_GetPlayedFrames(LONG nPort);

//23
////////////////ver 2.0 added///////////////////////////////////////
PLAYM4_API BOOL     PlayM4_SetDecCallBack(LONG nPort,void (* DecCBFun)(long nPort,char * pBuf,long nSize,FRAME_INFO * pFrameInfo, long nReserved1,long nReserved2));
PLAYM4_API BOOL     PlayM4_SetDisplayCallBackYUV(LONG nPort, void (* DisplayCBFun)(DISPLAY_INFO_YUV *pstDisplayInfo), BOOL bTrue, void* pUser);
PLAYM4_API BOOL     PlayM4_SetDisplayCallBack(LONG nPort,void (* DisplayCBFun)(long nPort,char * pBuf,long nSize,long nWidth,long nHeight,long nStamp,long nType,long nReserved));
PLAYM4_API BOOL     PlayM4_ConvertToBmpFile(char * pBuf,long nSize,long nWidth,long nHeight,long nType,char *sFileName);
PLAYM4_API DWORD     PlayM4_GetFileTotalFrames(LONG nPort);
PLAYM4_API DWORD     PlayM4_GetCurrentFrameRate(LONG nPort);
PLAYM4_API DWORD     PlayM4_GetPlayedTimeEx(LONG nPort);
PLAYM4_API BOOL     PlayM4_SetPlayedTimeEx(LONG nPort,DWORD nTime);
PLAYM4_API DWORD     PlayM4_GetCurrentFrameNum(LONG nPort);
PLAYM4_API BOOL     PlayM4_SetStreamOpenMode(LONG nPort,DWORD nMode);
PLAYM4_API DWORD     PlayM4_GetFileHeadLength();
PLAYM4_API DWORD     PlayM4_GetSdkVersion();
//11
////////////////ver 2.2 added///////////////////////////////////////
PLAYM4_API DWORD   PlayM4_GetLastError(LONG nPort);
PLAYM4_API BOOL  PlayM4_RefreshPlay(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetOverlayMode(LONG nPort,BOOL bOverlay,COLORREF colorKey);
PLAYM4_API BOOL  PlayM4_GetPictureSize(LONG nPort,LONG *pWidth,LONG *pHeight);
PLAYM4_API BOOL  PlayM4_SetPicQuality(LONG nPort,BOOL bHighQuality);
PLAYM4_API BOOL  PlayM4_PlaySoundShare(LONG nPort);
PLAYM4_API BOOL  PlayM4_StopSoundShare(LONG nPort);
//7
////////////////ver 2.4 added///////////////////////////////////////
PLAYM4_API LONG  PlayM4_GetStreamOpenMode(LONG nPort);
PLAYM4_API LONG  PlayM4_GetOverlayMode(LONG nPort);
PLAYM4_API COLORREF  PlayM4_GetColorKey(LONG nPort);
PLAYM4_API WORD  PlayM4_GetVolume(LONG nPort);
PLAYM4_API BOOL  PlayM4_GetPictureQuality(LONG nPort,BOOL *bHighQuality);
PLAYM4_API DWORD  PlayM4_GetSourceBufferRemain(LONG nPort);
PLAYM4_API BOOL  PlayM4_ResetSourceBuffer(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetSourceBufCallBack(LONG nPort,DWORD nThreShold,void ( * SourceBufCallBack)(long nPort,DWORD nBufSize,DWORD dwUser,void*pResvered),DWORD dwUser,void *pReserved);
PLAYM4_API BOOL  PlayM4_ResetSourceBufFlag(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetDisplayBuf(LONG nPort,DWORD nNum);
PLAYM4_API DWORD  PlayM4_GetDisplayBuf(LONG nPort);
PLAYM4_API BOOL  PlayM4_OneByOneBack(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetFileRefCallBack(LONG nPort, void ( *pFileRefDone)(DWORD nPort,DWORD nUser),DWORD nUser);
PLAYM4_API BOOL  PlayM4_SetCurrentFrameNum(LONG nPort,DWORD nFrameNum);
PLAYM4_API BOOL  PlayM4_GetKeyFramePos(LONG nPort,DWORD nValue, DWORD nType, PFRAME_POS pFramePos);
PLAYM4_API BOOL  PlayM4_GetNextKeyFramePos(LONG nPort,DWORD nValue, DWORD nType, PFRAME_POS pFramePos);
#if (WINVER >= 0x0400)
//Note: These funtion must be builded under win2000 or above with Microsoft Platform sdk.
//        You can download the sdk from "http://www.microsoft.com/msdownload/platformsdk/sdkupdate/";
PLAYM4_API BOOL  PlayM4_InitDDrawDevice();
PLAYM4_API void  PlayM4_ReleaseDDrawDevice();
PLAYM4_API DWORD  PlayM4_GetDDrawDeviceTotalNums();
PLAYM4_API BOOL  PlayM4_SetDDrawDevice(LONG nPort,DWORD nDeviceNum);
//PLAYM4_API BOOL  PlayM4_GetDDrawDeviceInfo(DWORD nDeviceNum,LPSTR  lpDriverDescription,DWORD nDespLen,LPSTR lpDriverName ,DWORD nNameLen,HMONITOR *hhMonitor);
PLAYM4_API int    PlayM4_GetCapsEx(DWORD nDDrawDeviceNum);
#endif
PLAYM4_API BOOL  PlayM4_ThrowBFrameNum(LONG nPort,DWORD nNum);
//23
////////////////ver 2.5 added///////////////////////////////////////
PLAYM4_API BOOL  PlayM4_SetDisplayType(LONG nPort,LONG nType);
PLAYM4_API long  PlayM4_GetDisplayType(LONG nPort);
//2
////////////////ver 3.0 added///////////////////////////////////////
PLAYM4_API BOOL  PlayM4_SetDecCBStream(LONG nPort,DWORD nStream);
PLAYM4_API BOOL  PlayM4_SetDisplayRegion(LONG nPort,DWORD nRegionNum, RECT *pSrcRect, HWND hDestWnd, BOOL bEnable);
PLAYM4_API BOOL  PlayM4_RefreshPlayEx(LONG nPort,DWORD nRegionNum);
#if (WINVER >= 0x0400)
//Note: The funtion must be builded under win2000 or above with Microsoft Platform sdk.
//        You can download the sdk from http://www.microsoft.com/msdownload/platformsdk/sdkupdate/;
PLAYM4_API BOOL  PlayM4_SetDDrawDeviceEx(LONG nPort,DWORD nRegionNum,DWORD nDeviceNum);
#endif
//4
/////////////////v3.2 added/////////////////////////////////////////

PLAYM4_API BOOL  PlayM4_GetRefValue(LONG nPort,BYTE *pBuffer, DWORD *pSize);
PLAYM4_API BOOL  PlayM4_SetRefValue(LONG nPort,BYTE *pBuffer, DWORD nSize);
PLAYM4_API BOOL  PlayM4_OpenStreamEx(LONG nPort,PBYTE pFileHeadBuf,DWORD nSize,DWORD nBufPoolSize);
PLAYM4_API BOOL  PlayM4_CloseStreamEx(LONG nPort);
PLAYM4_API BOOL  PlayM4_InputVideoData(LONG nPort,PBYTE pBuf,DWORD nSize);
PLAYM4_API BOOL  PlayM4_InputAudioData(LONG nPort,PBYTE pBuf,DWORD nSize);
PLAYM4_API BOOL  PlayM4_RegisterDrawFun(LONG nPort,void (* DrawFun)(long nPort,HDC hDc,LONG nUser),LONG nUser);
PLAYM4_API BOOL  PlayM4_RigisterDrawFun(LONG nPort,void (* DrawFun)(long nPort,HDC hDc,LONG nUser),LONG nUser);
//8
//////////////////v3.4/////////////////////////////////////////////////////
PLAYM4_API BOOL  PlayM4_SetTimerType(LONG nPort,DWORD nTimerType,DWORD nReserved);
PLAYM4_API BOOL  PlayM4_GetTimerType(LONG nPort,DWORD *pTimerType,DWORD *pReserved);
PLAYM4_API BOOL  PlayM4_ResetBuffer(LONG nPort,DWORD nBufType);
PLAYM4_API DWORD  PlayM4_GetBufferValue(LONG nPort,DWORD nBufType);

//////////////////V3.6/////////////////////////////////////////////////////////
PLAYM4_API BOOL  PlayM4_AdjustWaveAudio(LONG nPort,LONG nCoefficient);
PLAYM4_API BOOL  PlayM4_SetVerifyCallBack(LONG nPort, DWORD nBeginTime, DWORD nEndTime, void ( * funVerify)(long nPort, FRAME_POS * pFilePos, DWORD bIsVideo, DWORD nUser),  DWORD  nUser);
PLAYM4_API BOOL  PlayM4_SetAudioCallBack(LONG nPort, void ( * funAudio)(long nPort, char * pAudioBuf, long nSize, long nStamp, long nType, long nUser), long nUser);
PLAYM4_API BOOL  PlayM4_SetEncTypeChangeCallBack(LONG nPort,void( *funEncChange)(long nPort,long nUser),long nUser);
PLAYM4_API BOOL  PlayM4_SetColor(LONG nPort, DWORD nRegionNum, int nBrightness, int nContrast, int nSaturation, int nHue);
PLAYM4_API BOOL  PlayM4_GetColor(LONG nPort, DWORD nRegionNum, int *pBrightness, int *pContrast, int *pSaturation, int *pHue);
PLAYM4_API BOOL  PlayM4_SetEncChangeMsg(LONG nPort,HWND hWnd,UINT nMsg);
PLAYM4_API BOOL  PlayM4_GetOriginalFrameCallBack(LONG nPort, BOOL bIsChange,BOOL bNormalSpeed,long nStartFrameNum,long nStartStamp,long nFileHeader,void( *funGetOrignalFrame)(long nPort,FRAME_TYPE *frameType, long nUser),long nUser);
PLAYM4_API BOOL  PlayM4_GetFileSpecialAttr(LONG nPort, DWORD *pTimeStamp,DWORD *pFileNum ,DWORD *pReserved);
PLAYM4_API DWORD  PlayM4_GetSpecialData(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetCheckWatermarkCallBack(LONG nPort,void(* funCheckWatermark)(long nPort,WATERMARK_INFO* pWatermarkInfo,DWORD nUser),DWORD nUser);
PLAYM4_API BOOL  PlayM4_SetImageSharpen(LONG nPort,DWORD nLevel);
PLAYM4_API BOOL  PlayM4_SetDecodeFrameType(LONG nPort,DWORD nFrameType);
PLAYM4_API BOOL  PlayM4_SetPlayMode(LONG nPort,BOOL bNormal);
PLAYM4_API BOOL  PlayM4_SetOverlayFlipMode(LONG nPort,BOOL bTrue);
//PLAYM4_API DWORD  PlayM4_GetAbsFrameNum(LONG nPort); 

//////////////////V4.7.0.0//////////////////////////////////////////////////////
////convert yuv to jpeg
PLAYM4_API BOOL  PlayM4_ConvertToJpegFile(char * pBuf,long nSize,long nWidth,long nHeight,long nType,char *sFileName);
PLAYM4_API BOOL  PlayM4_SetJpegQuality(long nQuality);
//set deflash
PLAYM4_API BOOL  PlayM4_SetDeflash(LONG nPort,BOOL bDefalsh);
//PLAYM4_API BOOL  PlayM4_SetDecCallBackEx(LONG nPort,void (* DecCBFun)(long nPort,char * pBuf,long nSize,FRAME_INFO * pFrameInfo, long nReserved1,long nReserved2), char* pDest, long nDestSize);
//////////////////V4.8.0.0/////////////////////////////////////////////////////////
//check discontinuous frame number as error data?
PLAYM4_API BOOL  PlayM4_CheckDiscontinuousFrameNum(LONG nPort, BOOL bCheck);
//get bmp or jpeg
PLAYM4_API BOOL  PlayM4_GetBMP(LONG nPort,PBYTE pBitmap,DWORD nBufSize,DWORD* pBmpSize);
PLAYM4_API BOOL  PlayM4_GetJPEG(LONG nPort,PBYTE pJpeg,DWORD nBufSize,DWORD* pJpegSize);
//dec call back mend
PLAYM4_API BOOL  PlayM4_SetDecCallBackMend(LONG nPort,void (* DecCBFun)(long nPort,char * pBuf,long nSize,FRAME_INFO * pFrameInfo, long nUser,long nReserved2), long nUser);
PLAYM4_API BOOL  PlayM4_SetSecretKey(LONG nPort, LONG lKeyType, char *pSecretKey, LONG lKeyLen);

// add by gb 2007-12-23
PLAYM4_API BOOL  PlayM4_SetFileEndCallback(LONG nPort, void(*FileEndCallback)(long nPort, void *pUser), void *pUser);

// add by gb 080131 version 4.9.0.1
PLAYM4_API BOOL  PlayM4_GetPort(LONG* nPort);
PLAYM4_API BOOL  PlayM4_FreePort(LONG nPort);
PLAYM4_API BOOL  PlayM4_SetDisplayCallBackEx(LONG nPort,void (* DisplayCBFun)(DISPLAY_INFO *pstDisplayInfo), long nUser);
PLAYM4_API BOOL  PlayM4_SkipErrorData(LONG nPort, BOOL bSkip);
PLAYM4_API BOOL  PlayM4_SetDecCallBackExMend(LONG nPort, void (* DecCBFun)(long nPort, char* pBuf, long nSize, FRAME_INFO* pFrameInfo, 
                                                      long nUser, long nReserved2), char* pDest, long nDestSize, long nUser);
//reverse play add by chenjie 110609
PLAYM4_API BOOL  PlayM4_ReversePlay(LONG nPort);
PLAYM4_API BOOL  PlayM4_GetSystemTime(LONG nPort, PLAYM4_SYSTEM_TIME *pstSystemTime);

//PLAYM4_API BOOL  PlayM4_SetDecodeERC(long nPort, unsigned int nLevel);
...
PLAYM4_API BOOL  PlayM4_OpenStreamAdvanced(LONG nPort, int nProtocolType, PLAYM4_SESSION_INFO* pstSessionInfo, DWORD nBufPoolSize);
...
PLAYM4_API BOOL  PlayM4_SetRotateAngle(LONG nPort, DWORD nRegionNum, DWORD dwType);
...
PLAYM4_API BOOL  PlayM4_SetSycGroup(LONG nPort, DWORD dwGroupIndex);
...
PLAYM4_API BOOL  PlayM4_SetSycStartTime(LONG nPort, PLAYM4_SYSTEM_TIME *pstSystemTime);
...
typedef void ( * FISHEYE_CallBack )( void* pUser  , unsigned int  nSubPort , unsigned int nCBType , void * hDC ,   unsigned int nWidth , unsigned int nHeight); 

#endif
// 6.121    Enable Fisheye APIs
PLAYM4_API BOOL  PlayM4_FEC_Enable(LONG nPort);

// 6.122    Disable Fisheye APIs
PLAYM4_API BOOL  PlayM4_FEC_Disable(LONG nPort);

// Get Sub-port for Fisheye Correction [1~31] 
PLAYM4_API BOOL   PlayM4_FEC_GetPort(LONG nPort, unsigned int* nSubPort,FECPLACETYPE emPlaceType,FECCORRECTTYPE emCorrectType);

// 6.124    Delete Sub-port for Fisheye Correction 
PLAYM4_API BOOL  PlayM4_FEC_DelPort(LONG nPort , unsigned int nSubPort);

// 6.125    Set Fisheye Correction Parameters 
PLAYM4_API BOOL  PlayM4_FEC_SetParam(LONG nPort , unsigned int nSubPort , FISHEYEPARAM * pPara);

// 6.126    Get Fisheye Correction Parameters 
PLAYM4_API BOOL  PlayM4_FEC_GetParam(LONG nPort , unsigned int nSubPort , FISHEYEPARAM * pPara);

// Set Display Window
PLAYM4_API BOOL  PlayM4_FEC_SetWnd(LONG nPort , unsigned int nSubPort , void * hWnd);

//Set DDraw Callback for Fisheye Window
PLAYM4_API BOOL  PlayM4_FEC_SetCallBack(LONG nPort , unsigned int nSubPort , FISHEYE_CallBack cbFunc , void * pUser);

//motionflow
PLAYM4_API BOOL  PlayM4_MotionFlow(LONG nPort, DWORD dwAdjustType);
...
PLAYM4_API BOOL  PlayM4_VIE_SetModuConfig(LONG lPort,int nModuFlag,BOOL bEnable);


//Set image region of image enhancement 
PLAYM4_API BOOL  PlayM4_VIE_SetRegion(LONG lPort,LONG lRegNum,RECT* pRect);

//Get the enable module of image enhancement
PLAYM4_API BOOL  PlayM4_VIE_GetModuConfig(LONG lPort,int* pdwModuFlag);

//Set the parameter of the enable module of image enhancement
PLAYM4_API BOOL  PlayM4_VIE_SetParaConfig(LONG lPort,PLAYM4_VIE_PARACONFIG* pParaConfig);

//Get the parameter of the enable module of image enhancement
PLAYM4_API BOOL  PlayM4_VIE_GetParaConfig(LONG lPort,PLAYM4_VIE_PARACONFIG* pParaConfig);

//synchronization audio and video 
PLAYM4_API BOOL  PlayM4_SyncToAudio(LONG nPort, BOOL bSyncToAudio);

// PLAYM4_API BOOL  PlayM4_EnableIVS(LONG nPort, BOOL bTrue);
...
PLAYM4_API BOOL  PlayM4_RenderPrivateData(LONG nPort, int nIntelType, BOOL bTrue);

PLAYM4_API BOOL  PlayM4_RenderPrivateDataEx(LONG nPort, int nIntelType, int nSubType, BOOL bTrue);

PLAYM4_API BOOL  PlayM4_SetEncryptTypeCallBack(LONG nPort, 
                                                        void (* EncryptTypeCBFun)(long nPort, ENCRYPT_INFO* pEncryptInfo, long nReserved));

PLAYM4_API BOOL  PlayM4_GetStreamAdditionalInfo(LONG nPort, LONG lType, BYTE* pInfo, LONG* plLen);
