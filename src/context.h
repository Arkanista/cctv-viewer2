...
class Context : public QObject
{
    ...
    Q_PROPERTY(bool mockNewVersion READ mockNewVersion CONSTANT)
...
public:
    ...
    static bool mockNewVersion() { return m_mockNewVersion; }
...
private:
    ...
    inline static bool m_mockNewVersion = false;
